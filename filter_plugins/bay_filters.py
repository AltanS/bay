...
# ── Port-drift detection helpers (M83-S10) ──────────────────────────────
#
...
#
# Pre-M83-S10, this comparison was inlined in deploy_accessory.yml with a
...
def bay_spec_hash(spec, env_digest=None):
    ...
    # S1 (M85): fold in a non-reversible env/secrets digest for service and
...
# ── Access-gateway adapter: cross-host bind-IP resolver (M107) ───────────
#
...
#      is exactly the behaviour that shipped before M107.
