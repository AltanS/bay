...
Regression context (M80-S1):
  2026-04-17 — live verification of M75-S6 revealed the default was `"2g"`
...
def test_remote_build_setup_applies_memory_limit() -> None:
    ...
    remote-build setup block. 2026-04-17 M75-S6 verification exposed this:
