"""Render + schema + Python-validator tests for service `ports.expose:`.

Covers the fix for a cross-region service-link gap (GH bay#7):
...
class TestLinkTargetExposureValidator:
    ...
    def test_cross_region_link_to_accessory_with_expose_tailnet_passes(self):
        """Accessories use top-level `expose:` shape — validator
