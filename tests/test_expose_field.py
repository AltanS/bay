"""Render tests for the accessory `expose:` field.
...
def test_link_target_without_expose_defaults_to_loopback_after_s7():
    """After the expose-field change severed the links:-driven port rewrite, a
...
def test_expose_shim_removed_in_s7():
    """The backwards-compat shim was removed. If this test
    ...
    assert "127\\\\.0\\\\.0\\\\.1:" not in src, (
        "No IP-rewriting regex should remain in _macros.j2; the "
