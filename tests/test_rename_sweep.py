"""Rename sweep guard for M108 (Argo -> Bay).
...
guard described in `docs/rename-map.md` / M108-S01: it ships *before* any file
...
def test_reinject_detected(tmp_path: Path) -> None:
    ...
    M108-S01 -- leak-scan.sh passed for its whole life without anyone ever
    seeing it go red.
    """
