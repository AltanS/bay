...
def display_label(result: "CheckResult") -> str:
    ...
    pre-M85 layout. Full URL when `healthcheck_path` puts the probe on
...
def _collect_targets(
    ...
    preserving the pre-M85 behaviour. When set, it's the operator-declared
    route that exercises the dynamic backend (M85-S2)."""
