...
yet — see the M108 tracker milestone for the removal plan.

Canonical old→new identifier mapping for M108 (rename Argo → Bay). Every rename
...
## Not in scope for this rename (see M108 00-README non-goals)
